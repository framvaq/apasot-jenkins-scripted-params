node('java&&dev') {
  let cardNumber=input message: 'Introduce un número de tarjeta:', parameters: [string(defaultValue: '4111111111111111', description: 'Número de tarjeta por defecto', name: 'cardNumber')]
